<div class="sectorLists form">
<?php echo $this->Form->create('SectorList'); ?>
	<fieldset>
		<legend><?php echo __('Edit Sector List'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('SectorList.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('SectorList.id'))); ?></li>
