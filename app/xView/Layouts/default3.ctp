...
<head>
    ...
    <?php echo $this->Html->css('assets/css/pace-theme-minimal', null, array('inline' => false)); ?>
    <?php $this->Html->script('assets/scripts/custom/pace.min.js',array('inline' => false)); ?>
    <?php
    ...
    <div class="page-content-body">
        <div class="row">
            ...
            <div class="col-md-2 hidden-xs hidden-sm">
                ...
                <div class="clearfix">
                    <button class="btn blue btn-block">ADS</button>
                </div>
                <div class="list-group">
                    <a href="#" class="list-group-item">
                        <?php echo $this->Html->image('assets/img/fsibl.gif', array('class' => 'middle-footer-widget
                        img-responsive'));?>
                    </a>
                    <a href="#" class="list-group-item">
                        <?php echo $this->Html->image('assets/img/vat_center.gif', array('class' =>
                        'middle-footer-widget img-responsive'));?>
                    </a>
                    <a href="#" class="list-group-item">
                        <?php echo $this->Html->image('assets/img/add_wanted.gif', array('class' =>
                        'middle-footer-widget img-responsive'));?>
                    </a>
                    <a href="#" class="list-group-item">
                        <?php echo $this->Html->image('assets/img/bb.gif', array('class' => 'middle-footer-widget
                        img-responsive'));?>
                    </a>
                    <a href="#" class="list-group-item">
                        <?php echo $this->Html->image('assets/img/ICB.gif', array('class' => 'middle-footer-widget
                        img-responsive'));?>
                    </a>
                    <a href="#" class="list-group-item">
                        <?php echo $this->Html->image('assets/img/web-small.png', array('class' =>
                        'middle-footer-widget img-responsive'));?>
                    </a>
                </div>
            </div>
