...
<?php echo $this->Form->create('PortfolioTransaction'); ?>
	<fieldset>
		<legend><?php echo __('Edit Portfolio Transaction'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('PortfolioTransaction.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('PortfolioTransaction.id'))); ?></li>
