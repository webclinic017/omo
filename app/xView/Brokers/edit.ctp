...
<?php echo $this->Form->create('Broker'); ?>
	<fieldset>
		<legend><?php echo __('Edit Broker'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Broker.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('Broker.id'))); ?></li>
