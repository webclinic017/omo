<div class="dataBanksEods index">
	<h2><?php echo __('Data Banks Eods'); ?></h2>
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('adj_close'); ?></th>
	...
	<?php foreach ($dataBanksEods as $dataBanksEod): ?>
	<tr>
		<td><?php echo h($dataBanksEod['DataBanksEod']['id']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($dataBanksEod['DataBanksEod']['open']); ?>&nbsp;</td>
		<td><?php echo h($dataBanksEod['DataBanksEod']['high']); ?>&nbsp;</td>
		<td><?php echo h($dataBanksEod['DataBanksEod']['low']); ?>&nbsp;</td>
		<td><?php echo h($dataBanksEod['DataBanksEod']['close']); ?>&nbsp;</td>
		<td><?php echo h($dataBanksEod['DataBanksEod']['adj_close']); ?>&nbsp;</td>
		<td><?php echo h($dataBanksEod['DataBanksEod']['volume']); ?>&nbsp;</td>
		<td><?php echo h($dataBanksEod['DataBanksEod']['trade']); ?>&nbsp;</td>
		<td><?php echo h($dataBanksEod['DataBanksEod']['tradevalues']); ?>&nbsp;</td>
		<td><?php echo h($dataBanksEod['DataBanksEod']['date']); ?>&nbsp;</td>
		<td><?php echo h($dataBanksEod['DataBanksEod']['updated']); ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $dataBanksEod['DataBanksEod']['id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $dataBanksEod['DataBanksEod']['id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $dataBanksEod['DataBanksEod']['id']), null, __('Are you sure you want to delete # %s?', $dataBanksEod['DataBanksEod']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
