...
<?php echo $this->Form->create('DataBanksEod'); ?>
	<fieldset>
		<legend><?php echo __('Edit Data Banks Eod'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('DataBanksEod.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('DataBanksEod.id'))); ?></li>
