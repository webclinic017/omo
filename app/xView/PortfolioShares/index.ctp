<div class="portfolioShares index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('buying_date'); ?></th>
			<th><?php echo $this->Paginator->sort('is_active'); ?></th>
			<th><?php echo $this->Paginator->sort('share_status'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($portfolioShare['PortfolioShare']['no_of_shares']); ?>&nbsp;</td>
		<td><?php echo h($portfolioShare['PortfolioShare']['buying_price']); ?>&nbsp;</td>
		<td><?php echo h($portfolioShare['PortfolioShare']['buying_date']); ?>&nbsp;</td>
		<td><?php echo h($portfolioShare['PortfolioShare']['is_active']); ?>&nbsp;</td>
		<td><?php echo h($portfolioShare['PortfolioShare']['share_status']); ?>&nbsp;</td>
		<td><?php echo h($portfolioShare['PortfolioShare']['sell_price']); ?>&nbsp;</td>
		<td><?php echo h($portfolioShare['PortfolioShare']['sell_date']); ?>&nbsp;</td>
