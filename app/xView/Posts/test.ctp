...
<div class="row-fluid">
    <div class="span12">
        ...
        <h3 class="page-title">
            <?php echo __('Content Loading via Ajax'); ?><small>loading page content via ajax</small>
        </h3>
        <ul class="breadcrumb">
            <li>
                <i class="icon-home"></i>
    ...
    <div class="span12">
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption"><i class="icon-cogs"></i><?php echo __('Sample Form'); ?></div>
                <div class="tools">
...
<script>
    $('.select2').select2({
        ...
        <?php
          $this->assign('title', "This is assigned Title from post/test.ctp");
        ?>