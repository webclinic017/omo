<div class="userMetas index">
	...
	<tr>
		...
		<td><?php echo h($userMeta['UserMeta']['meta_description']); ?>&nbsp;</td>
		<td><?php echo h($userMeta['UserMeta']['meta_created']); ?>&nbsp;</td>
		<td><?php echo h($userMeta['UserMeta']['updated']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $userMeta['UserMeta']['id']), array(), __('Are you sure you want to delete # %s?', $userMeta['UserMeta']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
