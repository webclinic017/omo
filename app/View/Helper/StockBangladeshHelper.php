...
//pr($data);
  //      exit;
    ...
    public function getInstrumentBootstrapMultiSelect($data, $id)
    {
        // Logic to create specially formatted link goes here...
//pr($data);
  //      exit;

        $selectHtml = '<select id="' . $id . '" class="bs-select form-control" multiple data-live-search="true" title="Select ..." >';
        $selectHtml .= '<option value="0">---</option>';
