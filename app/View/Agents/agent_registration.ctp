                            ...
                            <ul class="nav nav-pills nav-justified steps">
                                ...
                                <li>
                                    <a href="#tab2" data-toggle="tab" class="step">
                                                ...
                                                2 </span>
                                                <span class="desc">
                                                <i class="fa fa-check"></i> Educational Qualification </span>
                                    </a>
                                </li>
                                <li>
                                    <a href="#tab3" data-toggle="tab" class="step active">
                                                ...
                                                3 </span>
                                                <span class="desc">
                                                <i class="fa fa-check"></i> Professional info </span>
                                    </a>
                                </li>
                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="tab1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" name="age" id="submit_form_password"/>
                                                        <span class="help-block">
                                                        Provide your age. </span>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-md-3">National id card No:<span class="required">
                                                    * </span>
                                        </label>
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" name="address"/>
                                                        <span class="help-block">
                                                        Provide your National id card No.</span>
                                        </div>
                                    </div>
                                    <div class="form-group">
