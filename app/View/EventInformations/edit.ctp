...
<?php echo $this->Form->create('EventInformation'); ?>
	<fieldset>
		<legend><?php echo __('Edit Event Information'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('EventInformation.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('EventInformation.id'))); ?></li>
