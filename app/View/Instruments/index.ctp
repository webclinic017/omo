<div class="instruments index">
	...
	<tr>
		...
		<td><?php echo h($instrument['Instrument']['instrument_code']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $instrument['Instrument']['id']), array(), __('Are you sure you want to delete # %s?', $instrument['Instrument']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
