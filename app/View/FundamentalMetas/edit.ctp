...
<?php echo $this->Form->create('FundamentalMeta'); ?>
	<fieldset>
		<legend><?php echo __('Edit Fundamental Meta'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('FundamentalMeta.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('FundamentalMeta.id'))); ?></li>
