...
<!--
                        <form id="UserProfileForm" action="<?php /*echo Router::url('/', true);*/?>UserInformations/update_users/" method="post">
...
<!--                <div id="tab_2-2" class="tab-pane">
                ...
                <div id="tab_3-3" class="tab-pane">
                    <form id="UserPasswordResetForm" action="<?php echo Router::url('/', true);?>users/change_password/" method="post">
                        <div class="form-group">
