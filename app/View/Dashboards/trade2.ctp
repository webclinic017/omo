...
<div class="col-md-6 col-sm-6">
    ...
    <div class="portlet light bg-inverse">
        <div class="portlet-title">
            <div class="caption">
                <i class="icon-puzzle font-blue-steel"></i>
        ...
        <div class="portlet-body form">
            ...
            <form id="Form1" action="javascript:updateChart()" class="form-horizontal form-row-seperated">
                <div class="form-body">
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label col-md-9">Adv order</label>
                        ...
                        <div class="col-md-8">
                            <div class="form-group hide" id="order_date_div">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <input id="order_date"  class="form-control form-control-inline input-medium date-picker" type="text" value="<?php echo date('Y-m-d');?>" >
                    ...
                    <div class="row">
                        <div class="form-group">
                            <label class="control-label col-md-3">Spot Order</label>
                            <div class="col-md-9">
                                <input id="spot_order"  class="form-control" type="text" value="" disabled>
                            </div>
                        </div>
                    </div>
                    <!--/row-->
                                    ...
                                    <div class="icheck-inline">
                                        <label>
                                            <input id="market_price" type="checkbox" class="icheck"
                                                   data-checkbox="icheckbox_flat-grey">market price

                                        </label>
                                                        <span class="help-block hide" id="market_price_help">
												<code>Takes MarketPrice</code>
												</span>
    ...
    $('.demo-loading-btn')
        .click(function () {
            ...
            if ($("#Form1").valid()) {
                ...
                var amount = $("#qty").val();
                var rate = $("#fixed_price_input").val();
                var rate_start_range = $("#range_price_input_start").val();
                var rate_end_range = $("#range_price_input_end").val();
                var drip_quantity = $("#drip_quantity").val();
                var order_date = $("#order_date").val();
                var spot_order=$("#spot_order").val();
