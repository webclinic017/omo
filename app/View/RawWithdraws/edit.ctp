<div class="rawWithdraws form">
<?php echo $this->Form->create('RawWithdraw'); ?>
	<fieldset>
		<legend><?php echo __('Edit Raw Withdraw'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('RawWithdraw.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('RawWithdraw.id'))); ?></li>
