...
if ($this->Session->read('Auth.User')) {
    ...
    <li class="dropdown dropdown-user dropdown-dark">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
            ...
            <?php echo $this->Html->image('assets/admin/layout3/img/avatar9.jpg',array( 'class' =>'img-circle')); ?>
            <span class="username username-hide-mobile"><?php  echo $this->Session->read('Auth.User.username'); ?></span>
        </a>
...
// user is logged in
if ($this->Session->read('Auth.User')) {
    echo $this->element('3_3/mega_menu_dynamic_logged_in');
}else {
    // echo $this->element('3_3/menu');
    echo $this->element('3_3/mega_menu_dynamic');
