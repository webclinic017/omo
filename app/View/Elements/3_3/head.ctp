...
<head>
    <meta charset="utf-8"/>
    <title>Share Market Analysis Portal For Dhaka Stock Exchange-Bangladesh</title>
...
/* if asset compression is not enable. Default is true. set $this->set('asset_compression_enable', false); in controller action to disable it*/
    if(!$css_asset_compression_enable) {
        ...
        echo $this->Html->css('assets/admin/layout3/css/layout', null, array('inline' => false));
        echo $this->Html->css('assets/admin/layout3/css/themes/default', null, array('inline' => false, 'id' => 'style_color'));
        echo $this->Html->css('assets/admin/layout3/css/collection', null, array('inline' => false));
        echo $this->Html->css('assets/admin/layout3/css/animate.css', null, array('inline' => false));
    }
    else {
