                ...
                <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-puzzle font-red-flamingo"></i>
                                                    <span class="caption-subject bold font-red-flamingo uppercase">date Wise Trade Volume (for Hcode) </span>
...
<div class="col-md-12" id="summery_table_div">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-puzzle font-red-flamingo"></i>
                                                    <span class="caption-subject bold font-red-flamingo uppercase">date Wise Trade Volume (for NonHcode) </span>
                        <span class="caption-helper hidden-xs"></span>
                    </div>
                </div>
...
<div class="col-md-12" id="summery_table_div">
                    ...
                    <div class="portlet-title">
                                <div class="caption">
                                    <i class="icon-puzzle font-red-flamingo"></i>
                                                                <span class="caption-subject bold font-red-flamingo uppercase">Client Wise Trade Volume (for Hcode)</span>
                                    <span class="caption-helper hidden-xs"></span>
                                </div>
                      </div>
...
<div class="col-md-12" id="summery_table_div">
                    ...
                    <div class="portlet-title">
                                <div class="caption">
                                    <i class="icon-puzzle font-red-flamingo"></i>
                                                                <span class="caption-subject bold font-red-flamingo uppercase">Client Wise Trade Volume (for NonHcode)</span>
                                    <span class="caption-helper hidden-xs"></span>
                                </div>
                      </div>
...
<div class="col-md-12" id="summery_table_div">
 <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-puzzle font-red-flamingo"></i>
        											<span class="caption-subject bold font-red-flamingo uppercase"><?=$unique?> Details Trade Volume  </span>
                        <span class="caption-helper hidden-xs"></span>
                    </div>
          </div>
 <table class="table table-striped table-bordered table-advance table-hover" id="deposit_summery_table">
...
<?php foreach($clientDetailsDataNonHClient as $unique=>$uniqClient ){ ?>
    ...
    <div class="col-md-12" id="summery_table_div">
        ...
        <table class="table table-striped table-bordered table-advance table-hover" id="deposit_summery_table">
            ...
            <?php foreach($clientDetailsDataNonHClient[$unique] as $key=>$clientData ){ ?>
                <tr>
