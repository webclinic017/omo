                                                ...
                                                <table class="six columns">
                                                    <tr>
                                                        <td class="vertical-middle" style="padding-top: 0;padding-bottom: 0;vertical-align: middle;">
                                                            <a href="<?php echo Router::url('/', true);?>/markets/home">

                                                                <img src="<?php echo Router::url('/', true);?>assets/img/logo.gif" class="ie10-responsive" alt="STOCKBANGLADESH LTD."/>
                                                ...
                                                <table class="four columns">
                                                    <tr>
                                                        <td class="vertical-middle" style="padding-top: 0;padding-bottom: 0;vertical-align: middle;color: #fff;">
                                                            &copy; StockBangladesh Ltd. <?php echo date('Y');?>.
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
