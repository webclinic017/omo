...
<?php echo $this->Form->create('CorporateAction'); ?>
	<fieldset>
		<legend><?php echo __('Edit Corporate Action'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('CorporateAction.id')), array(), __('Are you sure you want to delete # %s?', $this->Form->value('CorporateAction.id'))); ?></li>
