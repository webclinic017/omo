...
{
    // default connection
    public static $dbname = 'stock_sbnew'; // Your database name
    public static $dbuser = 'stock_newdbuser'; // Your database username
    public static $dbpass = 'Ry8_R(^G]f_P'; // // Your database password
