<?php
  //  error_reporting(0);
	...
	define("EZSQL_DB_USER", "dailysto_dbman");			// <-- mysql db user
	define("EZSQL_DB_PASSWORD", ".bWVGmPZ7sJ{");		    // <-- mysql db password
	define("EZSQL_DB_NAME", "dailysto_dsbdb");	            // <-- mysql db pname
	define("EZSQL_DB_HOST", "localhost");	                // <-- mysql server host
	//define("EZSQL_DB_HOST", "148.251.87.111:3306");	                // <-- mysql server host
