<?php
	...
	define("EZSQL_DB_USER", "stocknet_stms");			// <-- mysql db user
	define("EZSQL_DB_PASSWORD", "sTmS115^~!db");		    // <-- mysql db password
	define("EZSQL_DB_NAME", "stocknet_stock");	            // <-- mysql db pname
