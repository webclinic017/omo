...
error_reporting(0);
	...
	define("EZSQL_DB_USER", "stockbangladesh");			// <-- mysql db user
	define("EZSQL_DB_PASSWORD", "123456");		// <-- mysql db password
	define("EZSQL_DB_NAME", "mdsdata");		// <-- mysql db pname
	define("EZSQL_DB_HOST", "202.84.32.13");	// <-- mysql server host
	
	/*define("EZSQL_DB_USER1", "root");			// <-- mysql db user
	define("EZSQL_DB_PASSWORD1", "");		// <-- mysql db password
	define("EZSQL_DB_NAME1", "stockban_stock");		// <-- mysql db pname
	define("EZSQL_DB_HOST1", "localhost");	// <-- mysql server hostd
			*/
	define("EZSQL_DB_USER1", "stock_sbcake2");			// <-- mysql db user
	define("EZSQL_DB_PASSWORD1", "sbBangla@2010");		    // <-- mysql db password
	define("EZSQL_DB_NAME1", "stock_sbcake");	            // <-- mysql db pname
	define("EZSQL_DB_HOST1", "localhost");	                // <-- mysql server host
