...
Cache::config('minute', array(
    'engine' => 'Memcached',
  //  'prefix' => Inflector::slug(APP_DIR) . '_omo',
    'duration' => 60,
    'probability' => 300,
    'servers' => array('127.0.0.1:11211'),
));
Cache::config('login', array(
    'engine' => 'Memcached',
    'prefix' => Inflector::slug(APP_DIR) . '_omo',
    'duration' => 300,
    'probability' => 100,
...
Configure::write('EXCHANGE_ID', 1);
Configure::write('recaptcha_key', '6LfEFO4SAAAAAHiqFJ2c0rcZ7qdlvzxQWnMQ741u');
Configure::load('assets_conf');
Configure::load('rightside_ads');
Configure::load('menu');
Configure::load('broker_conf');
...
CakePlugin::load('AssetCompress', array('bootstrap' => true));*/
//Configure::write('Config.language', 'ben');
